...
- dependência de teste `io.quarkus:quarkus-jacoco` no build;
- propriedade `sonar.coverage.jacoco.xmlReportPaths` apontando para
...
- configuração Codex e hooks `SessionStart`/`Stop` que registram o fingerprint da sessão, lembram
